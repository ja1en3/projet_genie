...
<body>
    <div class="container-fluid-mb-0 header-border">
        ...
        <div class="container-fluid row">
            ...
            <p class="text-white text-center"> <br> <br> <br>
                Nous vous permetons d'accedée a tout nos plat juste en remplissant toutes les cases ci-dessous: 
            </p> <br> <br> <br>
        ...
        <div class="container" >
            ...
            <form class="col-8 border border-white bg-transparent d-grid gap-2 col-6 mx-auto" action="/commander" method="post" 
                ...
                <div class="mb-3">
                    <label for="order_details" class="form-label">Détails de la commande</label>
