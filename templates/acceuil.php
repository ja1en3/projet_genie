...
<head>
    ...
    <title>JFB</title>
    <link rel="stylesheet" href="../style/acceuil.css?v=<?php echo time(); ?>">
    ...
    <div class="container-fluid header-border">
        <div class="row">
            <div class="col-4 justify-content-center d-flex align-items-center">
                <p class="m-0"><img class="imag-fluide rounded-6" src="../src/logo.png" alt="Logo" width="200" height="250"></p>
            </div>
    ...
    <main>
        <section class="hero">
            <div class="hero-content">
                <h1>OPENING<br>Juice & Food Bar<br>Restaurant</h1>
                <p>Street</p>
                <p>Lorem ipsum dolor sit amet consectetur<br>vestibuet lorem odio luctus</p>
            </div>
            
            <div class="hero-images">
                <div class="img-box img1"><img src="../src/plat1.jpg" alt="Food"></div>
                <div class="img-box img2"><img src="../src/plat2.jpg" alt="Food"></div>
                <div class="img-box img3"><img src="../src/plat3.jpg" alt="Food"></div>
            </div>
        </section>
    </main>
